...
Gem::Specification.new do |spec|
  spec.name          = "best_coffee_cinci"
  spec.version       = BestCoffeeCinci::VERSION
  spec.authors       = ["'Marci Clark'"]
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/MarciClark/best_coffee_cinci.git"
    spec.metadata["changelog_uri"] = "https://github.com/MarciClark/best_coffee_cinci.git"
  else
  ...
  spec.add_dependency gem 'word_wrap'
end
